...
//                 <Col>
//                   <Button style={buttonStyle} onClick={toggleFilter}>
//                     동행인 <DownOutlined />
//                   </Button>
//                 </Col>
//                 <Col>
...
//                   <Button onClick={toggleFilter} style={{ backgroundColor: 'transparent', color: 'red' }}>
//                     취소
//                   </Button>
//                   <Button onClick={toggleFilter} style={{ backgroundColor: 'red', color: 'white' }}>
//                     결과보기
//                   </Button>
//                 </Row>
//               </div>
